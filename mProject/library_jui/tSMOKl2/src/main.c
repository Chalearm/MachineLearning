...
/*
    ...
    2 - no min checking
*/
void calCurrentEta(struct SMOKMBuff *obj);
...
{ 
    ...
    printSMOKMBuff(&smoBf,0x1F00);
        ...
        {
            inner_loop_sucess = 1;
            while(((smoBf.m_b_up > (smoBf.m_b_low - (2.0*TOL))) || (inner_loop_sucess == 0)) != 1)
            {
                smoBf.m_index2 = smoBf.m_i_low;
                smoBf.m_y2 = smoBf.m_points->m_out[smoBf.m_index2];
                smoBf.m_alpha2 = smoBf.m_alpha[smoBf.m_index2];
                smoBf.m_F2 = smoBf.m_fCache[smoBf.m_index2];
                smoBf.m_index1 =  smoBf.m_i_up;
                inner_loop_sucess = takeStep(&smoBf);
                numChanged += inner_loop_sucess;
