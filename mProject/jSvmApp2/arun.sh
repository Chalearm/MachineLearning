...
MAIN_LIB=${APATH}/jSvmApp2/lib
function exportLib
{
 export LD_LIBRARY_PATH=${MAIN_LIB}:${PATH_LIB}/TreeLib/lib:${PATH_LIB}/dataStruct/lib:${PATH_LIB}/strLibrary/lib:${PATH_LIB}/XMLLibrary/lib
}
function cleanBuild
{
 make clean
